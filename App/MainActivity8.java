...
public class MainActivity8 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String url = "http://192.168.1.2/get_value_pothole";                                        // --------- IP address --------
        ...
        client.newCall(request).enqueue(new Callback() {
            ...
            public void onResponse(Call call, Response response) throws IOException {
                if (response.isSuccessful()) {
                    ...
                    MainActivity8.this.runOnUiThread(new Runnable() {
                        @Override
                        public void run() {

                            String value = myResponse;
                            //Toast.makeText(MainActivity8.this, value, Toast.LENGTH_LONG).show();
                            ...
                            switch(val){
                                ...
                                case "song5":
                                    ...
                                    break;
                                default:
                                    Toast.makeText(MainActivity8.this, "Invalid", Toast.LENGTH_SHORT).show();
                            }
                        }
                    });
                }
        ...
        config_b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String url_song = url + "set_config_pothole?";
                    ...
                    public void onResponse(Call call, Response response) throws IOException {
                        if (response.isSuccessful()) {
                            ...
                            MainActivity8.this.runOnUiThread(new Runnable() {
                                @Override
                                public void run() {
                                    //Toast.makeText(MainActivity8.this, "Successfully Connected", Toast.LENGTH_SHORT).show();
                                }
                            });
                        }
                    }
