...
public class MainActivity9 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String url = "http://192.168.1.2/get_value_water";                                          // --------- IP address --------
        ...
        client.newCall(request).enqueue(new Callback() {
            ...
            public void onResponse(Call call, Response response) throws IOException {
                if (response.isSuccessful()) {
                    ...
                    MainActivity9.this.runOnUiThread(new Runnable() {
                        @Override
                        public void run() {

                            String value = myResponse;
                            //Toast.makeText(MainActivity9.this, value, Toast.LENGTH_LONG).show();
                            ...
                            switch(val){
                                ...
                                case "song5":
                                    ...
                                    break;
                                default:
                                    Toast.makeText(MainActivity9.this, "Invalid", Toast.LENGTH_SHORT).show();
                            }
                        }
                    });
                }
        ...
        config_b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String url_song = url + "set_config_water?";
                    ...
                    public void onResponse(Call call, Response response) throws IOException {
                        if (response.isSuccessful()) {
                            ...
                            MainActivity9.this.runOnUiThread(new Runnable() {
                                @Override
                                public void run() {
                                    //Toast.makeText(MainActivity9.this, "Successfully Connected", Toast.LENGTH_SHORT).show();
                                }
                            });
                        }
                    }
