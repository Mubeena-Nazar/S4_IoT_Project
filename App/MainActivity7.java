...
public class MainActivity7 extends AppCompatActivity {
    ...
    String song = "song2";
    int dis = 10;
    String det="Staircase Detection";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String url = "http://192.168.1.2/get_value_staircase";                                      // --------- IP address --------
        ...
        client.newCall(request).enqueue(new Callback() {
            ...
            public void onResponse(Call call, Response response) throws IOException {
                if (response.isSuccessful()) {
                    ...
                    MainActivity7.this.runOnUiThread(new Runnable() {
                        @Override
                        public void run() {

                            String value = myResponse;
                            //Toast.makeText(MainActivity7.this, value, Toast.LENGTH_LONG).show();
                            ...
                            switch(val){
                                ...
                                case "song5":
                                    ...
                                    break;
                                default:
                                    Toast.makeText(MainActivity7.this, "Invalid", Toast.LENGTH_SHORT).show();
                            }
                        }
                    });
                }
        ...
        config_b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String url_song = url + "set_config_staircase?";
                    ...
                    public void onResponse(Call call, Response response) throws IOException {
                        if (response.isSuccessful()) {
                            ...
                            MainActivity7.this.runOnUiThread(new Runnable() {
                                @Override
                                public void run() {
                                    //Toast.makeText(MainActivity7.this, "Successfully Connected", Toast.LENGTH_SHORT).show();
                                }
                            });
                        }
                    }
